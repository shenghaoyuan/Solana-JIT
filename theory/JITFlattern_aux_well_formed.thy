...
lemma jit_prog_prop2:"per_jit_ins ins = Some (num,off,l_bin0) \<Longrightarrow> \<exists> num src dst. x64_decode 0 l_bin0 = Some(num, Pcmpq_rr src dst) \<Longrightarrow>  num = 1"
...
lemma jit_prog_prop4:
  ...
  \<exists> num src dst. x64_decode 0 l_bin0 = Some(num, Pcmpq_rr src dst) \<Longrightarrow> 
  num = 1"
  ...
  next
    ...
    assume assm0: "jitper insns = Some (a#lt)" and
      ...
      assm3:"\<exists> num src dst. x64_decode 0 l_bin0 = Some(num, Pcmpq_rr src dst)"
